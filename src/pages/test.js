            ...
            <div style={props} > </div>
               ...
               >  */}
                    ...
                    <Spring from={{ marginTop: 500, opacity: 0 }} to={{ marginTop: 0, opacity: 1 }} delay='500'>
                        ...
                        {props => (
                            <div className='project-container-test' style={props} >




                                <Img className="project__img " fluid={this.props.data.image2.childImageSharp.fluid} />
                                <div className="overlay-test-4">
                                    <div className="project-overlay__title-test" >Gig Findr</div>

                                    <div className='project-overlay__description'>
                                        Full Stack Javascript CRUD App using React, Redux, Firebase and Firestore.
                                    </div>
                                    <div className="project-overlay__buttons-test">
